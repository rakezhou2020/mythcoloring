...
export const creatures: Creature[] = [
  ...
  },
  {
    ...
    localName: "浑沌",
    themeSlug: "shan-hai-jing",
    origin: "Myth-inspired coloring artwork of Hundun (浑沌).",
    shortDescription: "A round, many-limbed creature rests in a vast mountain landscape, its glowing tendrils curling around its face.",
    appearance: "This artwork depicts Hundun with a soft coral body, violet limbs, a pale underside, a toothy grin, and turquoise sensory tendrils.",
    legend: "The finished illustration places the creature amid fractured peaks and ancient ruins beneath a glowing circular sky, expanding the surreal mood of the coloring page.",
    symbolism: "Warm coral, violet, and turquoise form an unusual coloring palette, while broad body shapes and intricate mountain scenery balance simple and detailed areas.",
  ...
  },
  {
    ...
    localName: "梼杌",
    themeSlug: "shan-hai-jing",
    origin: "Myth-inspired coloring artwork of Taowu (梼杌).",
    shortDescription: "A ferocious, flame-maned beast charges across a shattered mountain pass beneath a moonlit sky.",
    appearance: "This artwork depicts Taowu with a mane of blue and turquoise flame, crimson claws, red eyes, long fangs, and a dark indigo body.",
    legend: "The finished illustration places the creature amid crumbling stone gates, airborne debris, and rugged mountains lit by a stormy sunset.",
    symbolism: "Cool blue flames and vivid crimson paws create a striking palette, while the mane and fractured rocks offer detailed coloring areas.",
  ...
  },
  {
    ...
    localName: "穷奇",
    themeSlug: "shan-hai-jing",
    origin: "Myth-inspired coloring artwork of Qiongqi (穷奇).",
    shortDescription: "A winged feline guardian crouches on a mountain crag beneath a cloudy moonlit sky.",
    appearance: "This artwork depicts Qiongqi with a golden coat, fiery red mane and tail, blue-and-gold wings, long dark claws, and a pale horn.",
    legend: "The finished illustration places the creature amid ruined mountain gates and storm clouds lit by a red eclipse, extending the dramatic coloring-page scene.",
    symbolism: "Gold fur, red flame-like markings, and layered blue wings create a vivid palette, while feathers and craggy stone add detailed coloring areas.",
  ...
  },
  {
    ...
    localName: "饕餮",
    themeSlug: "shan-hai-jing",
    origin: "Myth-inspired coloring artwork of Taotie (饕餮).",
    shortDescription: "A horned, long-beaked beast steps through a mountain stream with a blazing mane and flowing dark tail.",
    appearance: "This artwork depicts Taotie with green fur, a fiery orange-red mane, curved brown horns, a pale-yellow beak, and a sweeping deep-green tail.",
    legend: "The finished illustration places the creature among ancient stone gates, waterfalls, and forested peaks, extending the peaceful mountain scene of the coloring page.",
    symbolism: "Green fur, warm orange hair, and dark horns create a balanced natural palette, while the landscape and mane offer detailed areas to color.",
