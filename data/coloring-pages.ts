...
import huJiaoProduct from "../mythcoloring-workflow/output/hu-jiao/product.json";
import fenghuangProduct from "../mythcoloring-workflow/output/fenghuang/product.json";
import zhuanYuProduct from "../mythcoloring-workflow/output/zhuan-yu/product.json";
...
const huJiao: ColoringPage = {
  ...huJiaoProduct,
  id: huJiaoProduct.slug,
  creatureSlug: huJiaoProduct.slug,
  type: "Coloring Page",
  difficulty: "Detailed",
  colorCount: 5,
  featured: true,
...
const fenghuang: ColoringPage = {
  ...fenghuangProduct,
  id: fenghuangProduct.slug,
  creatureSlug: fenghuangProduct.slug,
  type: "Coloring Page",
  difficulty: "Detailed",
  colorCount: 5,
  featured: true,
...
const zhuanYu: ColoringPage = {
  ...zhuanYuProduct,
  id: zhuanYuProduct.slug,
  creatureSlug: zhuanYuProduct.slug,
  type: "Coloring Page",
  difficulty: "Detailed",
  colorCount: 4,
  featured: true,
...
const xianYang: ColoringPage = {
  ...xianYangProduct,
  id: xianYangProduct.slug,
  creatureSlug: xianYangProduct.slug,
  type: "Coloring Page",
  difficulty: "Detailed",
  colorCount: 4,
  featured: true,
...
const yong: ColoringPage = {
  ...yongProduct,
  id: yongProduct.slug,
  creatureSlug: yongProduct.slug,
  type: "Coloring Page",
  difficulty: "Detailed",
  colorCount: 4,
  featured: true,
...
const bianQu: ColoringPage = {
  ...bianQuProduct,
  id: bianQuProduct.slug,
  creatureSlug: bianQuProduct.slug,
  type: "Coloring Page",
  difficulty: "Detailed",
  colorCount: 4,
  featured: true,
